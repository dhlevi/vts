let serviceUrl = "http://localhost:9988/";
let refresh = true;
...
let app = new Vue(
{
    ...
    data: 
    {
        ...
        lastTab: 'designer',
        currentTab: 'designer',
        tabs: ['designer', 'map-viewer', 'about'],
        componentKey: 0,
...
{
    let processor = require(process.cwd() + '/lib/service/processors');
    await processor.requestProcessor(app.request);
}