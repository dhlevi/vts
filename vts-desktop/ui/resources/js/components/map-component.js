Vue.component('map-viewer',
{
    ...
    created: function () 
    {
        // esri map to be replaced with leaflet
        ...
        ]) 
        {
            ...
            app.request.processors.forEach(processor =>
            {
                ...
                if (engineUrl)
                {
                    ...
                    {
                        let filenames = require('fs').readdirSync('/cache/' + app.request.name + '/' + processor.name + '/' + node);
                        ...
                        {
                            let json = require('fs').readFileSync(file, 'utf8');
