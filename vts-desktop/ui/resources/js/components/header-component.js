    ...
    <div>
        <nav>
            <div class="row nav-wrapper primary-color-dark">
                <div class="col s12">
                    <a href="https://dhlevi.github.io/vts/" class="brand-logo" target="_blank">Vivid Topology Service</a>
        ...
        <div class="menubar primary-color-dark">
          ...
          <a href="#" class="waves-effect waves-white btn-flat primary-color-dark" onclick="app.tabSwitch('map-viewer')">Map</a>
        </div>
    </div>
    `
});