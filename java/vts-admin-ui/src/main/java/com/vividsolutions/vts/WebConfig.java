...
public class WebConfig extends WebMvcConfigurerAdapter
{
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) 
    {
        ...
        registry.addResourceHandler("/ui/*.jpg")
                .addResourceLocations("/static/");
    }
    
    @Bean
    public VTSController vtsController() throws InterruptedException
    {
        return new VTSController();
    }
    
    @Bean
    public AdminRequestEngine requestExecutionEngine()
    {
        return new AdminRequestEngine();
    }
